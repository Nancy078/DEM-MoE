...
DATASET_CONFIGS = {
    ...
    "off": {
        ...
        "features_pt":    "OFF_MOE_FEATS_NEW.pt",
        "demo_feats":     ["gender", "race", "age", "occupation", "education"],
        "batch_size":     128,
        "num_epochs":     50,
        "num_experts":    5,
        ...
        "baseline_mae":   None,
        "params": {
            "bias_lr":         0.0276844130748078,
            "lr_gate":         5.9353062832292536e-5,
            "lr_main":         1.5807097743457212e-3,
            "topk_exp":        2,
            "T_init":          13.15544091812928,
            "T_decay":         0.6327889306158523,
            "T_min":           2.6616875042007986,
            "T_warmup_epochs": 6,
            "kl_identity_w":   1e-4,
            "annot_weight":    1e-3,
            "overflow_on":     True,
            "capacity_scale":  1.1707900219619825,
            "cap_mult":        1.14399,
            "cap_mult_A":      0.8960083441919815,
            "cap_mult_B":      1.286425021551672,
            "cap_mult_C":      1.0876998865458676,
            "load_w_A":        0.26109281932159034,
            "orth_w_A":        0.05068470934369791,
            "var_w_A":         0.09828150002076738,
            "load_w_B":        0.46399034544215156,
            "orth_w_B":        0.2524388225960015,
            "var_w_B":         0.10151431614764068,
            "load_w_C":        0.8968565427803654,
            "orth_w_C":        0.4495671074919112,
            "var_w_C":         0.5845318163517061,
            "encoder_bump":    1.5,
            "load_w":          0.26109281932159034,
            "orth_w":          0.05068470934369791,
            "var_w":           0.09828150002076738,
            "demog_kl_w":      0.01115568115433457,
        },
    },
}
